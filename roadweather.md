...
First, use the drop-down menus to choose a period and a season. 
...
### West and South of the Baltic Sea (including southern Sweden)
...
<br>
Attention: The <b>average</b> maximum road surface temperture (average over the entire 2041-2060 period) does not portray individual heat waves in which road surface temperatures can be much higher than 30°C.
...
### East, West and South of the Baltic Sea (including southern Sweden)
